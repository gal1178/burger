...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { category_id: @dish.category_id, cost: @dish.cost, name: @dish.name, uncategory_id: @dish.uncategory_id }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { category_id: @dish.category_id, cost: @dish.cost, name: @dish.name, uncategory_id: @dish.uncategory_id }
    assert_redirected_to dish_path(assigns(:dish))
  end
